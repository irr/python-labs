...
# (virtualenv)
pip install boto3 pymysql redis glances httpie pillow jsonschema requests gevent boto3 functools32 backports.shutil_get_terminal_size pathlib2 enum ipython ntlk textblob facebook-sdk
```
